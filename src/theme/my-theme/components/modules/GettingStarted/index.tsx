...
type ComponentProps = {
  fieldValues: GettingStartedFieldValues;
  hublParameters: { brandColors?: { color?: string; opacity?: number } };
};

export function Component({ fieldValues, hublParameters }: ComponentProps) {
